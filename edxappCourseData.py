...
# -----------------------------------------------
# To remove in production version : Tests
# -----------------------------------------------
"""
# Mongo DB Connect
from pymongo import Connection
...
bg_id='6'
course_id='ibl/1/2015_01'
xblock_category='iblstudiosbadges'

badge_list_problems = getListProblemsFromBadgeId(mongo_modulestore,bg_id,course_id,xblock_category)
print badge_list_problems

#badge_problems_score =getScoreFromBadgeId(mongo_modulestore,bg_id,course_id,xblock_category)
